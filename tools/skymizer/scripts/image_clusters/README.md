...
sys.path.insert(0, 'tools/skymizer/scripts/image_clusters')
...
.venv/bin/python tools/skymizer/scripts/image_clusters/replace_subsamples.py prepare \
...
```bash
.venv/bin/python tools/skymizer/scripts/image_clusters/replace_subsamples.py publish \
...
```bash
.venv/bin/python tools/skymizer/scripts/image_clusters/replace_subsamples.py verify \
...
```bash
.venv/bin/python -m unittest discover \
  -s tools/skymizer/scripts/image_clusters -p 'test_*.py' -v
```
