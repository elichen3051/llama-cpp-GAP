...
#
# Production command:
#   python tools/skymizer/cli/prepare_perplexity_corpus.py --corpus CORPUS --corpus-name NAME \
...
( cd -- "$SKYMIZER_REPO" && run_logged "$LOG" "$PYTHON" "$SKYMIZER_REPO/tools/skymizer/cli/prepare_perplexity_corpus.py" \
