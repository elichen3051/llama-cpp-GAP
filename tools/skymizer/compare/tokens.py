# compare/tokens.py -- Per-token machinery: answer-position strata and the pooled quantile
...
from compare.inference import _build_weighting_block
...
# (knowledge/notes-power-variance-decomposition.md) put the mmproj
