# compare/render.py -- Markdown rendering of a result dict (pure formatting), plus the inputs /
...
from compare.contracts import SCHEMA_VERSION
from compare.inference import _format_confidence_level
from compare.tokens import _CRITICAL_SAMPLE_TABLE_ROWS
