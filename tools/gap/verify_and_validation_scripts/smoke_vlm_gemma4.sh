...
#   DATASET=company/ground-truth-mmmu-pro-vision-sampling-500 \
#   SUBSET=Qwen3-VL-4B-Instruct \
#   OUT_ROOT=outputs/smoke-qwen3vl4b \
#     ./verify_and_validation_scripts/smoke_vlm_gemma4.sh
# =============================================================================
...
DATASET=${DATASET:-user-company/GAP-mmmu-pro-standard-10}
